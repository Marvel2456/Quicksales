...
class Inventory(models.Model):
    ...
    quantity_restocked = models.PositiveIntegerField(default=0, blank=True, null=True)
    quantity_transfered = models.PositiveIntegerField(default=0, blank=True, null=True)
